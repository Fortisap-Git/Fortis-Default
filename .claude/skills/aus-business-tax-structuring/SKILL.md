...
- **Cost base**: purchase price of land and building, acquisition costs (duty, legal, valuation, building inspection), non-deductible holding costs, capital improvements, title costs. Reduce by Div 43 deducted or deductible for a property acquired after 13 May 1997 (s 110-45(2)). Fortis house method for Div 40 plant: keep it in the cost base and deduct the Div 40 depreciation already claimed; show the strict per-item balancing adjustment in the workpaper.
- **Broker or adviser cost estimates**: ask whether a quoted transfer cost already includes duty. If it does, do not add duty again in the upfront total (the model's `duty_included_in_transfer_costs` flag).
