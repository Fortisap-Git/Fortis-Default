...
- Asset: 5-room rooming house, Wacol QLD, land about $424,676 (being $862,500 less the $437,824 build), build $437,824 including $68,005 plant, first rented 25 May 2023, Div 43 claimed about $34,000 to a December 2026 transfer, land value $250,000, indicative market value $1.475m (broker, not a formal valuation).
...
| Cost base (land $424,676 + build $437,824 − plant $68,005 − Div 43 $34,000; element 2 costs not yet on file) | $760,495 | same | same |
| Capital gain | $714,505 | same | same |
| 50% discount (held 3.7 years, individual, pre 1 July 2027) | $357,252 net gain | same | same |
| Tax at marginal rates plus Medicare on top of $190k | **$167,909** | same | same |
| QLD transfer duty on $1.475m | **$65,338** | same | same |
| Broker's transfer and refinance costs (check whether duty is inside the $79k) | $79,000 | same | same |
| Set up | about $3,500 | about $4,000 | about $4,500 |
| **Upfront total** | **about $315,000** | about $316,000 | about $316,000 |
...
| **Payback** | **about 100 years** | longer | longer |

Element 2 acquisition costs (QLD duty on the land purchase, legal) would raise the cost base by perhaps $15,000 to $20,000 and cut the tax by about $4,000 to $5,000; it does not change the answer.
...
- **Depreciation**: the transferee could not claim Div 40 on the second-hand plant (s 40-27); Div 43 of $9,208 a year continues.
...
The short answer is that moving Wilga Street into a company or trust doesn't stack up. Because you'd be transferring to an entity you control, the tax law treats it as a sale at market value, so at $1.475m we'd be looking at a capital gain of roughly $715,000. Our records give a cost base of about $760,000, being the land at around $425,000 and the build at $438,000 less the plant and equipment (which is treated separately) and the capital works we've claimed since 2023. We don't yet have the settlement statement from the land purchase, which would add the duty and legals you paid then, but that only moves the number by a few thousand. With the 50% discount, the tax on the gain at your marginal rate is about $168,000. On top of that, because the property is in Wacol, Queensland transfer duty on $1.475m is about $65,000, and that may or may not already be inside the broker's $79,000 estimate, so worth checking with them. All up you're at roughly $315,000 before anyone has saved a dollar of interest.

Against that, the refinance saves around $7,000 a year, and running a company or trust adds around $4,000 a year in accounts, returns and ASIC fees, so the net benefit is about $3,000 a year. That's a payback of a century, and it gets worse if the property is ever sold from a company, which pays 30% on the whole gain with no discount. There's no rollover that helps here. The small business concessions need a business asset rather than a rental, and the rollover into a wholly owned company gives up the discount permanently, so it would cost more later than it saves now. Of the entity options a unit trust would be the least bad, mainly because the government's new 30% minimum tax on family trusts from July 2028 makes a discretionary trust a poor home for property, but none of them get near paying for themselves.
